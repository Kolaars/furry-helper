...
script_author("MTG MODS   kolaars")
...
function onSystemMessage(msg, type, script)
	if script and script.name == 'Arizona&Rodina Helper' and msg and ((msg:find('stack traceback')) or (type == 3 and not msg:find('Script died due to an error'))) then
		...
		'��������� �������� � {ff9900}���.��������� MTG MODS (Telegram/Discord/BlastHack){ffffff}.\n\n' ..
		'������ ��������� ������:\n{ff6666}' .. msg)
		sampShowDialog(123123, '{009EFF}Arizona&Rodina Helper [' .. script.version .. ']', errorMessage, '������� ������', '', 0)
	end
end
    ]]
...
function handleNewWeapon(weaponId)
    ...
    sampAddChatMessage('[Arizona Helper] {ffffff}�������� ��� ��� ������������ ������ �� ������ � /rpguns', message_color)
...
function main()
	...
	if settings.general.auto_mask then
   	 ...
   	 if now - lastMaskTime >= (20 * 60 + 5) then
       	 sampSendChat('/mask')
       	 lastMaskTime = now
       	 sampAddChatMessage('[Arizona Helper] {ffffff}������������� ������ ����� (������ 20 ��� 5 ���).', message_color)
    	end
	end
			...
			if MODULE.Patrool.active then
				...
				if settings.mj.auto_change_code_siren and isCharInAnyCar(PLAYER_PED) then
					...
					if currentSirenState ~= lastSirenState then
						...
						sampAddChatMessage("[Arizona Helper | ���������] {ffffff}������ " .. (currentSirenState and "��������, ���������� ���-��� CODE 3!" or "���������, ���������� ���-��� CODE 4."), message_color)
...
function welcome_message()
	...
	sampAddChatMessage('[Arizona Helper] {ffffff}�������� ������� ������ �������!', message_color)
	show_notify('info', 'Arizona Helper', "�������� ������� ������ �������!", 3000)
	print('������ �������� ������� ������ �������!')
						...
						elseif line == "{pause}" then
							...
							if not IS_MOBILE then
								if hotkey_no_errors and settings.general.bind_action then
									sampAddChatMessage('[Arizona Helper] {ffffff}��� ����������� ������� ' .. message_color_hex .. getNameKeysFrom(settings.general.bind_action) .. ' {ffffff}��� �������� ������ ������ ��� (T/F6)', message_color)
								else
									sampAddChatMessage('[Arizona Helper] {ffffff}��� ����������� �������� ������ ������ ��� (T/F6)', message_color)
								end
							end
...
function initialize_commands()
	...
	sampRegisterChatCommand("binder", function() 
		...
		sampAddChatMessage('[Arizona Helper] {ffffff}������ ���������� �� ������� "������� � RP ���������" -> "RP �������"', message_color)
	end)
	...
	sampRegisterChatCommand("rpguns", function()
		if settings.general.rp_guns then
			...
			sampAddChatMessage('[Arizona Helper] {ffffff}�������� ������� "RP ��������� ������" � /helper -> ������� ' .. modules.player.data.fraction_tag, message_color)
		end
	end)
		...
		if server == 0 or server < 200 then
			if not MODULE.Binder.state.isActive then
				if MODULE.CruiseControl.active then
					...
					sampAddChatMessage('[Arizona Helper] {ffffff}����� "CRUISE CONTROL" ��������!', message_color)
				else
					if not isCharInAnyCar(PLAYER_PED) then
						sampAddChatMessage('[Arizona Helper] {ffffff}�� ������ ���������� � ������������ ��������!', message_color)
						return
			...
			sampAddChatMessage('[Arizona Helper] {ffffff}������ ������� �������� ������ �� ����� GTA SA! ����� CRMP ��� Vice City �� ��������!', message_color)
			play_sound()
		end
	end)
	sampRegisterChatCommand("activate", function() 
		sampAddChatMessage('[Arizona Helper] {ffffff}� ��������� ������ ����� �� ���� ������� �� VIP ������!', message_color) 
		sampAddChatMessage('[Arizona Helper] {ffffff}��������� � Telegram/Discord VIP ���� (@mtgmods_vip_bot), � ����������� ������', message_color) 
		sampAddChatMessage('[Arizona Helper] {ffffff}����� ��������� �������, � ���� ����������� ������� /helper ��� ��������� VIP', message_color)
	end)
	sampRegisterChatCommand("debug", function() 
		MODULE.DEBUG = not MODULE.DEBUG 
		sampAddChatMessage('[Arizona Helper] {ffffff}������������ ������ � ������� ' .. (MODULE.DEBUG and '��������!' or '���������!'), message_color) 
	end)
			...
			if not MODULE.Binder.state.isActive then
				if isParamSampID(arg) then
					if #modules.smart_uk.data ~= 0 then
						...
						sampAddChatMessage('[Arizona Helper] {ffffff}������� ���������/��������� ������� ������ ������� � /helper - ������� ' .. modules.player.data.fraction_tag, message_color)
						play_sound()
					end
				else
			...
			elseif not MODULE.Wanted.checker then
				lua_thread.create(function()
					...
					if #MODULE.Wanted.new == 0 then
						...
						sampAddChatMessage('[Arizona Helper] {ffffff}������������ /wanted ��������! ������� ������������: ' .. message_color_hex .. #MODULE.Wanted.new, message_color)
		...
		sampRegisterChatCommand('zeks', function()
			if settings.gov.custom_zeks then
				...
				elseif not MODULE.Zeks.checker then
					sampAddChatMessage('[Arizona Helper] {ffffff}������������ /zeks...', message_color)
				...
				sampAddChatMessage('[Arizona Helper] {ffffff}�� ������ �������� ��������� ���� /zeks � ����-����������� � /helper - ������� �����', message_color)
				sampSendChat('/zeks')
			end
		end)
	end
...
function get_vehicle_name(id)
	...
	sampAddChatMessage('[Arizona Helper] {ffffff}�� ������� �������� ������ �/c ' .. id .. " ID, �������� ������ ����������...", message_color)
...
function send_no_vip_msg()
	for i = 1, 10, 1 do
		sampAddChatMessage('[Arizona Helper] {ffffff}���� ���������� ����������/��������� � FREE ������! ����������� �������� MTGVIP!', message_color)
	end
	sampShowDialog(123123, '{009EFF}Arizona&Rodina Helper [' .. thisScript().version .. ']', '{ffffff}���� ���������� ����������/��������� � FREE ������!\n����������� �������� MTGVIP ��� ������� �������!', '������� ������', '', 0)
end
...
function downloadFileFromUrlToPath(url, path)
	...
	local function on_finish_download()
		...
		elseif download_file == 'smart_uk' then
			sampAddChatMessage('[Arizona Helper] {ffffff}�������� ������� ����� ������ ������� ��� ������� ' .. message_color_hex .. getServerName(getServerNumber()) .. ' [' .. getServerNumber() ..  '] {ffffff}��������� �������!',  message_color)
			sampAddChatMessage('[Arizona Helper] {ffffff}������ �� ������ ������������ ������� ' .. message_color_hex .. '/sum [ID ������]', message_color)
...
function get_fraction_cmds(selected, is_manage)
    local cmds = {
		{cmd = 'time', description = '���������� �����',  text = '/me ��������{sex} �� ���� ���� � ����������� Arizona Helper by MTG MODS&/time&/do �� ����� ����� ����� {get_time}.', arg = '', enable = true, waiting = '2', bind = "{}"},
...
function import_data_from_old_helpers()	
	...
	local function import_settings(folder)
		...
		sampAddChatMessage('[Arizona Helper] {ffffff}������ ����� ������ (������) � ������� �� ' .. message_color_hex .. folder .. '{ffffff} ������� ��������!', message_color)
	...
	local function import_split(folder)
		...
		if doesFileExist(notesPath) then 
			...
			if n and n.note then
				...
				sampAddChatMessage('[Arizona Helper] {ffffff}������ ����� ������� �� ' .. message_color_hex .. folder .. ' Helper {ffffff} ������� ��������!', message_color)
				os.remove(notesPath)
			end
		end
	...
	local function safeMove(folder, file, target)
		...
		if readJsonSafe(p) then 
			os.rename(p, target)
			sampAddChatMessage('[Arizona Helper] {ffffff}������ "' .. file .. '" �� ' .. message_color_hex .. folder .. '{ffffff} ������� ��������!', message_color)
		end
	end
...
if isMode('police') or isMode('fbi') then
	function form_su(name, playerID, message)
		...
		if (modules.player.data.fraction_rank_number >= rank) then
			...
			sampAddChatMessage('[Arizona Helper | ���������] {ffffff}����������� ' .. message_color_hex .. '/givefsu ' .. playerID .. '{ffffff} ����� ������ ������ �� ������� ������� ' .. message_color_hex .. name, message_color)
			play_sound()
		else
			sampAddChatMessage('[Arizona Helper | ���������] {ffffff}��� ������ ������� �� ������� ����� ����� ' .. rank .. '-� ����, �� �� ������ ' .. modules.player.data.fraction_rank_number .. '-� ���� :(', message_color)
		end
	end
end
			...
			for hello_bro, keyword in ipairs(MODULE.HealChat.worlds) do
				if (message:rupper():find(keyword:rupper())) then
					...
					elseif hotkey_no_errors then
						sampAddChatMessage('[Arizona Helper] {ffffff}����� �������� ������ ' .. sampGetPlayerNickname(id) .. ' ������� ' .. message_color_hex .. getNameKeysFrom(settings.general.bind_action) .. ' {ffffff}� ������� 5-�� ������!', message_color)
	...
	function try_send_ad(text)
		...
		if MODULE.SmiEdit.ad_repeat_count >= 51 then
			...
			if modules.ads_history.data then
				...
				sampAddChatMessage('[Arizona Helper] {ffffff}�������� ���� ' .. modules.ads_history.path, message_color)
				sampAddChatMessage('[Arizona Helper] {ffffff}������� ���, ���� ���� ������, �� ������� ������ � ��������� (���� � ��������� 1251)', message_color)
				play_sound()
			end
			return false
		end
			...
			if weapon_name then
				...
				if isMode('police') or isMode('fbi') or isMode('army') or isMode('prison') then
					if ((MODULE.Patrool.Window[0]) and (MODULE.Patrool.ComboCode[0] ~= 1)) then
						sampAddChatMessage('[Arizona Helper | ���������] {ffffff}��� ������������ ��� ������� �� CODE 0.', message_color)
...
function sampev.onServerMessage(color, text)
	...
	if isMode('smi') then
		...
		or text:find('^VIP ����������:') or text:find('^����������� ����������:') then -- rodina
			...
			sampAddChatMessage('[Arizona Helper] {ffffff}��������� ����� ���������� �� ������ ' .. message_color_hex .. nick, message_color)
			return false
		end
	...
	if isMode('hospital') then
		...
		if text:find('^%(%( ����� ������� �����, ������� /godeath (%d+). ������ �� ����� (.+) %)%)') then
			...
			if MODULE.GoDeath.locate == '�����������' then
				sampAddChatMessage('[Arizona Helper] {ffffff}�� ������ ' .. message_color_hex .. MODULE.GoDeath.city .. ' {ffffff}�������� ����� � ������������ ' .. message_color_hex .. sampGetPlayerNickname(MODULE.GoDeath.player_id), message_color)
			else
				sampAddChatMessage('[Arizona Helper] {ffffff}�� ������ ' .. message_color_hex .. MODULE.GoDeath.city .. ' (' .. MODULE.GoDeath.locate .. ') {ffffff}�������� ����� � ������������ ' .. message_color_hex .. sampGetPlayerNickname(MODULE.GoDeath.player_id), message_color)
			end
			sampAddChatMessage('[Arizona Helper] {ffffff}������� ��� �� �������� ' .. price_godeath .. '! ����� ������� �����, ����������� ������� ' .. message_color_hex .. cmd .. ' ' .. MODULE.GoDeath.player_id, message_color)
			return false
		end
		if text:find("^������� (.+) �������� ������ .+����.+����") then
			sampAddChatMessage('[Arizona Helper] {ffffff}������� ' .. text:match("������� (.+) ��������") .. ' �������� ����� � ���� ��������!', message_color)
			return false
		end
	...
	if isMode('lc') then
		if text:find('^�� ��������������� �������� ����: (.+) ���� ��������%: (.+)') then
			...
			sampAddChatMessage('[Arizona Helper] {ffffff}�� ������ ��������� ����� �� ���������� ' .. money, message_color)
		...
		if text:find('^%[������%](.+)� ������ ��� ���� ����� �������� ������ ����� ��� (.+)') then
			...
			sampAddChatMessage('[Arizona Helper] {ffffff}� ������ ��� ���� ����� �������� ������ ����� ��� ' .. days, message_color)
			sampSendChat('� ��� ��� ���� ����� �������� ������ ����� ��� ' .. days)
			return false
		end
		if (text:find('^%[������%](.+)�� �� ������ ��������� �������� �� ����� ����')) then
	...
	if isMode('fd') then
		if (text:find("������������(.+)� ����� ��������� �����! ���� ��������� (%d) ������")) then
			...
			sampAddChatMessage('[Arizona Helper] {ffffff}� ����� ����� ����� ' .. MODULE.Fires.lvl .. ' ������� ���������!', message_color)
		...
		if (text:find("%[����������%] {ffffff}�������� ������ ����� ������������ ����� (%d+) �����")) then
			sampAddChatMessage('[Arizona Helper] {ffffff}�������� ������ ����� ������������ ����� ' .. text:match("����� (%d+) �����") .. ' �����!', message_color)
			return false
		end
		if (MODULE.Fires.isZone) then
			...
			if text:find("%[����������%] {ffffff}�� ���������� �� ������������ {90EE90}$(.+){FFFFFF}, ������� �������������� ����� �� ���� �����������") then
				...
				sampAddChatMessage('[Arizona Helper] {ffffff}����� ��������, �� ��� ���������� �� ����������: ' .. message_color_hex .. '$' .. (text:match('{90EE90}$(.+){FFFFFF}') or 'nil'), message_color)
...
function sampev.onShowDialog(dialogid, style, title, button1, button2, text)
	...
	if check_stats and (title:find('�������� ����������') or title:find('���������� ������')) then
		if text:find("���") then
			...
			sampAddChatMessage('[Arizona Helper] {ffffff}���� ��� � ������� ����������: ' .. modules.player.data.name_surname, message_color)
        end
		if text:find("���:") then
			modules.player.data.sex = text:match("{FFFFFF}���: {......}%[(.-)]") or text:match("{ffffff}���:%s+{......}([^\n\r]+)")
			sampAddChatMessage('[Arizona Helper] {ffffff}��� ��� ���������: ' .. modules.player.data.sex, message_color)
		end
		if text:find("�����������:") then
			...
			if data then
				sampAddChatMessage('[Arizona Helper] {ffffff}���� ����������� ����������, ���: '..modules.player.data.fraction, message_color)
				modules.player.data.fraction_tag = data[1]
				settings.general.fraction_mode = data[2]
				sampAddChatMessage('[Arizona Helper] {ffffff}����� ����������� �������� ��� '..modules.player.data.fraction_tag .. ". �� �� ������ �������� ���.", message_color)
				if text:find("���������:") then
					...
					sampAddChatMessage('[Arizona Helper] {ffffff}���� ��������� ����������, ���: ' .. modules.player.data.fraction_rank .. " (" .. modules.player.data.fraction_rank_number .. ")", message_color)
					if modules.player.data.fraction_rank_number >= 9 then
				...
				sampAddChatMessage('[Arizona Helper] {ffffff}�� ������� �������� ���� ����������� � ���������!', message_color)
				sampAddChatMessage('[Arizona Helper] {ffffff}�������� ��� ����� ��� ����������� (���� - ���� - 1).', message_color)
				sampAddChatMessage('[Arizona Helper] {ffffff}���� �� ������������� �������� � ����������� - ������������� ������ �������.', message_color)
			end
			if old_fraction_mode ~= '' and old_fraction_mode ~= 'none' and old_fraction_mode ~= settings.general.fraction_mode then
				sampAddChatMessage('[Arizona Helper] {ffffff}�� ������ � ������ �������, ������� ������ ������� ' .. old_fraction_mode:rupper(), message_color)
	...
	if ((MODULE.Members.info.check) and (title:find('(.+)%(� ����: (%d+)%)') or title:find('� ���� ����� .+ ���.+�����������'))) then
		...
		elseif #MODULE.Members.new ~= 0 then
			...
			if not settings.general.auto_update_members then
				sampAddChatMessage('[Arizona Helper] {ffffff}�� ������ �������� ����-���������� ������ /mb /helper - ������� ' .. modules.player.data.fraction_tag .. '!', message_color)
			end
		...
		if (MODULE.LeadTools.cleaner.uninvite) then
			...
			if title:find('���������� %(�������%)') then
				...
				if #MODULE.LeadTools.cleaner.players_to_kick > 0 then
					sampAddChatMessage('[Arizona Helper] {ffffff} ������� ' .. #MODULE.LeadTools.cleaner.players_to_kick .. ' ������� ������� ' .. MODULE.LeadTools.cleaner.day_afk .. " ���� �� � ����!", message_color)
					lua_thread.create(function()
					...
					sampAddChatMessage('[Arizona Helper] {ffffff} ���� ������� ������� ' .. MODULE.LeadTools.cleaner.day_afk .. " ���� �� � ����!",  message_color)
				end
	...
	if isMode('gov') then
		if settings.gov.anti_trivoga and (text:find('�� ������������� ������ ������� ����������� �������?') or text:find('�� ������������� ������ {FFA11C}�������{FFFFFF} �������?')) then
			sampAddChatMessage('[Arizona Helper] {ffffff}��������� ������ ���������. ��� ��������� ����������� /helper - ������� �����', message_color)
			sampSendDialogResponse(dialogid, 2, 0, 0)
			return false
		end
		if MODULE.Zeks.checker and title:find("���� ��� ������") then
			...
			if #MODULE.Zeks.new == 0 then
				...
				sampAddChatMessage('[Arizona Helper] {ffffff}������������ /zeks ��������! ������� ����������� �������: ' .. message_color_hex .. #MODULE.Zeks.new, message_color)
	...
	if (isMode('lc')) then
		if title:find("�������� �����") and (title:find("Los Santos") or title:find("San Fierro") or title:find("Las Venturas") or title:find("Lav Venturas")) and settings.lc.auto_find_clorest_znak then
			...
			if not nearest then
				...
				sampAddChatMessage("[Arizona Helper | ���������] {ffffff}��������� � ��� ���� " .. message_color_hex .. "�" .. nearest.number .. " {ffffff}(��������� " .. message_color_hex .. nearest.distance .. "�{ffffff}, ������ " .. message_color_hex .. nearest.status .. "{ffffff})", message_color)
...
function sampev.onPlayerChatBubble(player_id, color, distance, duration, message)
	...
	if (isMode('police') or isMode('fbi') or isMode('prison')) and settings.mj.anti_screpki then
		if message:find("(.+) ������ ������� ��� ������ ����������") then
			...
			sampAddChatMessage('[Arizona Helper] {ffffff}��������! ' .. nick .. '[' .. id .. '] ���������� ������� � �������� ���������� ���������!', message_color)
			play_sound()
			...
			if result then
				...
				if getDistanceBetweenCoords3d(mx, my, mz, x, y, z) <= 1.5 then
					...
					sampAddChatMessage('[Arizona Helper] {ffffff}��������� � ������ ' .. nick .. ' � ����������� ������� /bot ' .. id, message_color)
				end
			...
			if cmd == 17 then
				...
				if (cmd:find('findGame') and cmd:find(' ����������","������� ')) then
					if ((not isMode('ins')) or (isMode('ins') and settings.ins.hint_in_sort)) then
						...
						sampAddChatMessage("[Arizona Helper | ���������] {ffffff}���������� ��������: " .. result .. ". ������� �� ����� ����� �������", message_color)
		...
		if imgui.BeginTabBar(u8'������!') then	
					...
					if imgui.BeginPopupModal(getHelperIcon() .. u8' ��������� � ����������� ' .. getHelperIcon() .. '##fraction_rank', _, imgui.WindowFlags.NoCollapse + imgui.WindowFlags.NoResize + imgui.WindowFlags.NoScrollbar) then
						...
						if imgui.Button(fa.FLOPPY_DISK .. u8' ���������##save_fraction_rank', imgui.ImVec2(200 * settings.general.custom_dpi, 25 * settings.general.custom_dpi)) then
							...
							if old_rank_number < 9 and modules.player.data.fraction_rank_number >= 9 then
								reload_script = true
								sampAddChatMessage("[Arizona Helper] {FFFFFF}��������� �� ����� " .. (modules.player.data.fraction_rank_number == 10 and '�������' or '������������') .. ", ����� ������������� ������ ��� ���������� ���.�������. ������������...", message_color)
								thisScript():reload()
							end	
							imgui.CloseCurrentPopup()
						end
						...
						function render_fastmenu(name, use, text, text2)
							if imgui.BeginChild('##fastmenu'..name, imgui.ImVec2(193.3 * settings.general.custom_dpi, 338 * settings.general.custom_dpi), true) then
								...
								if imgui.Button(fa.GEAR .. u8(' ��������� ������� ���� ') .. "##" .. name) then
									if name == 'Leader FastMenu' and modules.player.data.fraction_rank_number < 9 then
										sampAddChatMessage('[Arizona Helper] {ffffff}������ ��������� �������� �������� ������ ��� 9 ��� 10 �����!', message_color)
									else
								...
								if imgui.BeginPopupModal(fa.CIRCLE_PLUS .. u8' �������� ��� ������ ����� �������� ' .. fa.CIRCLE_PLUS, _, imgui.WindowFlags.NoCollapse + imgui.WindowFlags.NoResize) then
									...
									if imgui.ItemSelector(u8'', { u8'���� �����', u8'������� ��� �������' }, MODULE.PieMenu.editor.selector, 200 * settings.general.custom_dpi) then
										...
										if number < 5 then
											...
											if thisScript().version:find('VIP') then
												sampAddChatMessage('[Arizona Helper] {ffffff}��� ������������ ����� 8 ��������� � ����� ����, ����������� �������!', message_color)
											else
												sampAddChatMessage('[Arizona Helper] {ffffff}����������� 5 (� VIP 8) ��������� � ����� ����, ����������� ������� ��� VIP!', message_color)
											end
										end
										imgui.CloseCurrentPopup()
									end
						...
						if IS_MOBILE then
							...
							if imgui.Button(fa.CIRCLE_PLUS .. u8' �������� ������##add_mobile_button', imgui.ImVec2(imgui.GetMiddleButtonX(1), 0)) then
								if #modules.buttons.data >= 5 then
									send_no_vip_msg()
									sampAddChatMessage('[Arizona Helper] {ffffff}� ���������� ������ ����������� ����� 5 ������! ������ VIP ������ ��� ����������� ������!', message_color)
									return
								end
			...
			if imgui.BeginTabItem(fa.GEAR..u8' ���������') then 
				if imgui.BeginChild('##1', imgui.ImVec2(589 * settings.general.custom_dpi, 187 * settings.general.custom_dpi), true) then
					...
					if imgui.IsItemHovered() then
						imgui.SetTooltip(u8'������� � Discord ������ MTG MODS')
					end
					imgui.SameLine()
					imgui.Text('/')
					imgui.SameLine()
					...
					if imgui.BeginPopupModal(fa.TRIANGLE_EXCLAMATION .. u8' �������������� ' .. fa.TRIANGLE_EXCLAMATION .. '##change_size', _, imgui.WindowFlags.NoResize + imgui.WindowFlags.NoScrollbar) then
						...
						if imgui.Button(fa.CIRCLE_ARROW_RIGHT .. u8' ��, ��������##change_size', imgui.ImVec2(200 * settings.general.custom_dpi, 25 * settings.general.custom_dpi)) then
							...
							if IS_MOBILE and new_dpi < MONET_DPI_SCALE then
								sampAddChatMessage('[Arizona Helper] {ffffff}��� ������ ������� ������ ������� ������ ������ ' .. MONET_DPI_SCALE, message_color)
								imgui.CloseCurrentPopup()
							else
								settings.general.custom_dpi = new_dpi
								save_settings()
								sampAddChatMessage('[Arizona Helper] {ffffff}���� ��������� ����� ������� ' .. size_text .. ', �� ����������� ������� ' .. message_color_hex .. '/fixsize', message_color)
								sampAddChatMessage('[Arizona Helper] {ffffff}������������ ������� ��� ��������� ������� ����������...', message_color)
								reload_script = true
								thisScript():reload()
							end
		...
		function(player)
			...
			if settings.mj.auto_update_wanteds then
				...
				if imgui.Button(u8'�������� ������ ������������', imgui.ImVec2(340 * settings.general.custom_dpi, 25 * settings.general.custom_dpi)) then
					MODULE.Wanted.Window[0] = false
					sampAddChatMessage('[Arizona Helper] {ffffff}�� ������ �������� ����-���������� ������ /wanteds � /helper - ������� ' .. modules.player.data.fraction_tag .. '!', message_color)
		...
		function(player)
			...
			if imgui.Button(fa.CIRCLE_ARROW_RIGHT .. u8" ������������", imgui.ImVec2(imgui.GetMiddleButtonX(3), 25 * settings.general.custom_dpi)) then
				...
				if MODULE.SmiEdit.vip_pause then
					lua_thread.create(function()
						sampAddChatMessage('[Arizona Helper | ���������] {ffffff}��������� �� 10 ��� ����� VIP ������, �����...', message_color)
						play_sound()
		...
		function(player)
			...
			if settings.gov.auto_update_zeks then
				...
				if imgui.Button(u8'�������� ������ �����������', imgui.ImVec2(450 * settings.general.custom_dpi, 25 * settings.general.custom_dpi)) then
					MODULE.Zeks.Window[0] = false
					sampAddChatMessage('[Arizona Helper] {ffffff}�� ������ �������� ����-���������� ������ /zeks � /helper - ������� ' .. modules.player.data.fraction_tag .. '!', message_color)
...
imgui.OnFrame(
    ...
    function(player)
		...
		if not check then
			sampAddChatMessage('[Arizona Helper] {ffffff}��������� FastMenu � /helper - ������� � RP ��������� - ���� ���� - FastMenu', message_color)
			MODULE.FastMenu.Window[0] = false
		end
		imgui.End()
    end
...
imgui.OnFrame(
    ...
    function(player)
		...
		if IS_MOBILE and not check then
			sampAddChatMessage('[Arizona Helper] {ffffff}��������� Leader FastMenu � /helper - ������� � RP ��������� - ���� ���� - Leader FastMenu', message_color)
			MODULE.FastMenu.Window[0] = false
	...
	function(player)
		...
		if pie.BeginPiePopup('PieMenu', 2) then
			...
			if #modules.piemenu.data == 0 then
				sampAddChatMessage('[Arizona Helper] {ffffff}��������� ��� ��������� PieMenu � /helper - ������� � RP ��������� - ���� ���� - PieMenu', message_color)
			end
...
imgui.OnFrame(
    ...
    function(player)
		...
		if imgui.Button(fa.DOWNLOAD ..u8' ��������� ' .. u8(MODULE.Update.version), imgui.ImVec2(250 * settings.general.custom_dpi, 25 * settings.general.custom_dpi)) then
			if thisScript().version:find('VIP') then
				sampAddChatMessage('[Arizona Helper] {ffffff}����������� ������� /helper � ����� Telegram/Discord VIP ����!', message_color)
			else
